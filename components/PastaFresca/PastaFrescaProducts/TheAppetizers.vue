...
export default {
  ...
  computed: {
    extractedProductsAppetizers () {
      return productData.filter(el => el.category === 'pasta-fresca-appetizers')
    },
    extractedProductsAppetizersEn () {
      return productDataEn.filter(el => el.category === 'pasta-fresca-appetizers')
    },
    extractedProductsAppetizersRu () {
      return productDataRu.filter(el => el.category === 'pasta-fresca-appetizers')
    }
  },
