<template>
  ...
  >
    <div class="content">
      ...
      >
        <div
          v-for="product in extractedProductFirstCourseEn"
          :key="product.id"
          class="card"
        >
          <img
      ...
      >
        <div
          v-for="product in extractedProductFirstCourseRu"
          :key="product.id"
          class="card"
        >
          <img
...
export default {
  ...
  computed: {
    extractedProductFirstCourse () {
      return productData.filter(el => el.category === 'pasta-fresca-firstCourses')
    },
    extractedProductFirstCourseEn () {
      return productDataEn.filter(el => el.category === 'pasta-fresca-firstCourses')
    },
    extractedProductFirstCourseRu () {
      return productDataRu.filter(el => el.category === 'pasta-fresca-firstCourses')
    }
  },
