<template>
  ...
  >
    <div class="content">
      ...
      >
        <div
          v-for="product in extractedProductMainMealsEn"
          :key="product.id"
          class="card"
        >
          <img
      ...
      >
        <div
          v-for="product in extractedProductMainMealsRu"
          :key="product.id"
          class="card"
        >
          <img
...
export default {
  ...
  computed: {
    extractedProductMainMeals () {
      return productData.filter(el => el.category === 'pasta-fresca-mainMeals')
    },
    extractedProductMainMealsEn () {
      return productDataEn.filter(el => el.category === 'pasta-fresca-mainMeals')
    },
    extractedProductMainMealsRu () {
      return productDataRu.filter(el => el.category === 'pasta-fresca-mainMeals')
    }
  },
