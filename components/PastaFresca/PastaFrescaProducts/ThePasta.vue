<template>
  ...
  >
    <div class="content">
      ...
      >
        <div
          v-for="product in extractedProductPastaEn"
          :key="product.id"
          class="card"
        >
          <img
      ...
      >
        <div
          v-for="product in extractedProductPastaRu"
          :key="product.id"
          class="card"
        >
          <img
...
export default {
  ...
  computed: {
    ...
    extractedProductPastaEn () {
      return productDataEn.filter(el => el.category === 'pasta-fresca-pasta')
    },
    extractedProductPastaRu () {
      return productDataRu.filter(el => el.category === 'pasta-fresca-pasta')
    }
  },
  methods: {
