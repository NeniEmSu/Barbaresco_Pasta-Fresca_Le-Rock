...
export default {
  ...
  computed: {
    extractedProductDesert () {
      return productData.filter(el => el.category === 'barbaresco-deserts')
    },
    extractedProductDesertEn () {
      return productDataEn.filter(el => el.category === 'barbaresco-deserts')
    },
    extractedProductDesertRu () {
      return productDataRu.filter(el => el.category === 'barbaresco-deserts')
    }
  },
