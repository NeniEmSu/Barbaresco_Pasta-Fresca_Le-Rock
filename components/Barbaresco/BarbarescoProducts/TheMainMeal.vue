...
export default {
  ...
  computed: {
    extractedProductMainMeals () {
      return productData.filter(el => el.category === 'barbaresco-mainMeals')
    },
    extractedProductMainMealsEn () {
      return productDataEn.filter(el => el.category === 'barbaresco-mainMeals')
    },
    extractedProductMainMealsRu () {
      return productDataRu.filter(el => el.category === 'barbaresco-mainMeals')
    }
  },
