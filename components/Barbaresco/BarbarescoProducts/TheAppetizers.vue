...
export default {
  ...
  computed: {
    extractedProductsAppetizers () {
      return productData.filter(el => el.category === 'barbaresco-appetizers')
    },
    extractedProductsAppetizersEn () {
      return productDataEn.filter(el => el.category === 'barbaresco-appetizers')
    },
    extractedProductsAppetizersRu () {
      return productDataRu.filter(el => el.category === 'barbaresco-appetizers')
    }
  },
