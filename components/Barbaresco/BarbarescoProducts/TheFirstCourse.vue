...
export default {
  ...
  computed: {
    extractedProductFirstCourse () {
      return productData.filter(el => el.category === 'barbaresco-firstCourses')
    },
    extractedProductFirstCourseEn () {
      return productDataEn.filter(el => el.category === 'barbaresco-firstCourses')
    },
    extractedProductFirstCourseRu () {
      return productDataRu.filter(el => el.category === 'barbaresco-firstCourses')
    }
  },
