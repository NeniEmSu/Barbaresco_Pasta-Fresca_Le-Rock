<template>
  ...
  >
    <div class="content">
      ...
      >
        <div
          v-for="product in extractedProductPancakesEn"
          :key="product.id"
          class="card"
        >
          <img
      ...
      >
        <div
          v-for="product in extractedProductPancakesRu"
          :key="product.id"
          class="card"
        >
          <img
      ...
      >
        <div
          v-for="product in extractedProductPancakes"
          :key="product.id"
          class="card"
        >
          <img
...
export default {
  ...
  computed: {
    extractedProductPancakes () {
      return productData.filter(el => el.category === 'barbaresco-pancakes')
    },
    extractedProductPancakesEn () {
      return productDataEn.filter(el => el.category === 'barbaresco-pancakes')
    },
    extractedProductPancakesRu () {
      return productDataRu.filter(el => el.category === 'barbaresco-pancakes')
    }
  },
