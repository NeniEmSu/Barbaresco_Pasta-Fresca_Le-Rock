<template>
  ...
  >
    <div class="content">
      ...
      >
        <div
          v-for="product in extractedProductsGarnishesEn"
          :key="product.id"
          class="card"
        >
          <img
          ...
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-sm-7 p-0  my-auto text-center">
                <button
      ...
      >
        <div
          v-for="product in extractedProductsGarnishesRu"
          :key="product.id"
          class="card"
        >
          <img
...
export default {
  ...
  computed: {
    extractedProductsGarnishes () {
      return productData.filter(el => el.category === 'barbaresco-garnishes')
    },
    extractedProductsGarnishesEn () {
      return productDataEn.filter(el => el.category === 'barbaresco-garnishes')
    },
    extractedProductsGarnishesRu () {
      return productDataRu.filter(el => el.category === 'barbaresco-garnishes')
    }
  },
