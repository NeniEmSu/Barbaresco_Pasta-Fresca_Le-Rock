<template>
  ...
  >
    <div class="content">
      ...
      >
        <div
          v-for="product in extractedProductMainMealEn"
          :key="product.id"
          class="card"
        >
          <img
      ...
      >
        <div
          v-for="product in extractedProductMainMealRu"
          :key="product.id"
          class="card"
        >
          <img
      ...
      >
        <div
          v-for="product in extractedProductMainMeal"
          :key="product.id"
          class="card"
        >
          <img
...
export default {
  ...
  computed: {
    extractedProductMainMeal () {
      return productData.filter(el => el.category === 'le-rock-mainMeals')
    },
    extractedProductMainMealEn () {
      return productDataEn.filter(el => el.category === 'le-rock-mainMeals')
    },
    extractedProductMainMealRu () {
      return productDataRu.filter(el => el.category === 'le-rock-mainMeals')
    }
  },
