...
export default {
  ...
  computed: {
    extractedProductSalads () {
      return productData.filter(el => el.category === 'le-rock-salads')
    },
    extractedProductSaladsEn () {
      return productDataEn.filter(el => el.category === 'le-rock-salads')
    },
    extractedProductSaladsRu () {
      return productDataRu.filter(el => el.category === 'le-rock-salads')
    }
  },
