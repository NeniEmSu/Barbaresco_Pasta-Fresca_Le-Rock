<template>
  ...
  >
    <div class="content">
      ...
      >
        <div
          v-for="product in extractedProductBBQMeatEn"
          :key="product.id"
          class="card"
        >
          <img
          ...
          <div class="card-body">
            <h5
              ...
              :title="product.name.length > 18 ? product.name : ''"
            >
              {{ product.name }}
            </h5>
            <p
              ...
              style="cursor: context-menu;"
              :title="product.summary.length > 35 ? product.summary : ''"
            >
              {{ (product.summary).slice(0, 35) }}<span v-if="product.summary.length > 35">...</span><span class="card-text quantity">{{ product.volume }}</span>
            </p>
      ...
      >
        <div
          v-for="product in extractedProductBBQMeatRu"
          :key="product.id"
          class="card"
        >
          <img
      ...
      >
        <div
          v-for="product in extractedProductBBQMeat"
          :key="product.id"
          class="card"
        >
          <img
...
export default {
  ...
  computed: {
    extractedProductBBQMeat () {
      return productData.filter(el => el.category === 'le-rock-meat-bbq')
    },
    extractedProductBBQMeatEn () {
      return productDataEn.filter(el => el.category === 'le-rock-meat-bbq')
    },
    extractedProductBBQMeatRu () {
      return productDataRu.filter(el => el.category === 'le-rock-meat-bbq')
    }
  },
