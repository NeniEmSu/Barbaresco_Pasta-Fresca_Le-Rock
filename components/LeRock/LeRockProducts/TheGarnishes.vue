...
export default {
  ...
  computed: {
    extractedProductsGarnishes () {
      return productData.filter(el => el.category === 'le-rock-garnishes')
    },
    extractedProductsGarnishesEn () {
      return productDataEn.filter(el => el.category === 'le-rock-garnishes')
    },
    extractedProductsGarnishesRu () {
      return productDataRu.filter(el => el.category === 'le-rock-garnishes')
    }
  },
