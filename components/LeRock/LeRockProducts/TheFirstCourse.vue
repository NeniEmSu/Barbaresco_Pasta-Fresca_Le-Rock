...
export default {
  ...
  computed: {
    extractedProductFirstCourse () {
      return productData.filter(el => el.category === 'le-rock-firstCourses')
    },
    extractedProductFirstCourseEn () {
      return productDataEn.filter(el => el.category === 'le-rock-firstCourses')
    },
    extractedProductFirstCourseRu () {
      return productDataRu.filter(el => el.category === 'le-rock-firstCourses')
    }
  },
